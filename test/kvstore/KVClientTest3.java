 ...
 * These are tests for methods put/get/del
 * These tests will only work if all other pieces of this project are working correctly
 * These tests test for functionality and for edge case error checking
 * Tests uses endToEnd Template
 */

public class KVClientTest3 extends EndToEndTemplate {
